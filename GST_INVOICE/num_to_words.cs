...
namespace GST_INVOICE
{
    class num_to_words
    {
        ...
        public static string convert_number( double num)
        {
            //double d = 1234.5678;
            string text = "";
            double d = num;
            ...
            if (d.ToString().Contains("."))
            {
                ...
                text ="RUPEES "+ NumberToText(i, true, false) + " AND " + DecimalToText(decimalPart) +" PAISA ONLY";
            }
            else
            {
                text = "RUPEES " + NumberToText(i, true, false) +" ONLY";
            }
